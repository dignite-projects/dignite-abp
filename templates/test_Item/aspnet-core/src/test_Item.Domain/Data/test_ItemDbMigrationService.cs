...
public class test_ItemDbMigrationService : ITransientDependency
{
    public ILogger<test_ItemDbMigrationService> Logger { get; set; }
    ...
    public test_ItemDbMigrationService(
        ...
        IEnumerable<Itest_ItemDbSchemaMigrator> dbSchemaMigrators)
    {
        ...
        Logger = NullLogger<test_ItemDbMigrationService>.Instance;
    }
