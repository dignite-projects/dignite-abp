...
[Authorize(Permissions.TenantDomainsPermissions.GroupName)]
public class TenantDomainAppService : TenantDomainsAppServiceBase, ITenantDomainAppService
{
    ...
    [Authorize(Permissions.TenantDomainsPermissions.Update)]
