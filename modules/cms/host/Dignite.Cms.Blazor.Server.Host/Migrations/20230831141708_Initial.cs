        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevisionInitialId = table.Column<Guid>(name: "Revision_InitialId", type: "uniqueidentifier", nullable: true),
                    RevisionVersion = table.Column<int>(name: "Revision_Version", type: "int", nullable: true),
                    RevisionIsActive = table.Column<bool>(name: "Revision_IsActive", type: "bit", nullable: true),
                    RevisionNotes = table.Column<string>(name: "Revision_Notes", type: "nvarchar(512)", maxLength: 512, nullable: true),
                    ParentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Order = table.Column<int>(type: "int", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
