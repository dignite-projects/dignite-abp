...
namespace Migrations
{
    ...
    [Migration("20250801083636_RenameCoverImageToBlobInPost")]
    partial class RenameCoverImageToBlobInPost
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dignite.Publisher.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.PrimitiveCollection<string>("PostTypes")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("pbl_Categories", (string)null);
                });

            modelBuilder.Entity("Dignite.Publisher.Posts.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("pbl_Posts", (string)null);
            ...
            modelBuilder.Entity("Dignite.Publisher.Posts.PostCategory", b =>
                {
                    ...
                    b.ToTable("pbl_PostCategories", (string)null);
                });
            ...
            modelBuilder.Entity("Dignite.Publisher.Posts.ArticlePost", b =>
                {
                    b.HasBaseType("Dignite.Publisher.Posts.Post");
            ...
            modelBuilder.Entity("Dignite.Publisher.Posts.VideoPost", b =>
                {
                    b.HasBaseType("Dignite.Publisher.Posts.Post");
            ...
            modelBuilder.Entity("Dignite.Publisher.Posts.PostCategory", b =>
                {
                    b.HasOne("Dignite.Publisher.Categories.Category", "Category")
                        .WithMany("CategoryPosts")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dignite.Publisher.Posts.Post", "Post")
