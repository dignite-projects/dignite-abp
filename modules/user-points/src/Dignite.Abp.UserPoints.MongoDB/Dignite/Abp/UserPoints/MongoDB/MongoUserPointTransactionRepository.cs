...
public class MongoUserPointTransactionRepository : MongoDbRepository<IUserPointsMongoDbContext, UserPointTransaction, Guid>, IUserPointTransactionRepository
{
    private readonly IClock _clock;
    public MongoUserPointTransactionRepository(IMongoDbContextProvider<IUserPointsMongoDbContext> dbContextProvider, IClock clock)
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var userPointTransactions = await (await GetMongoQueryableAsync(cancellationToken))
            ...
            .As<IMongoQueryable<UserPointTransaction>>()
    ...
    public virtual async Task<List<UserPointTransaction>> GetListAsync(
        Guid userId,
        Guid? accountId = null,
        int? minAmount = null,
        int? maxAmount = null,
