...
{
    private readonly INotificationAppService _sampleAppService;
    private readonly IIdentityModelAuthenticationService _authenticationService;
    private readonly IConfiguration _configuration;

    public ClientDemoService(
        INotificationAppService sampleAppService,
    ...
    private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            var url = _configuration["RemoteServices:NotificationCenter:BaseUrl"] +
                      "api/NotificationCenter/sample/authorized";
