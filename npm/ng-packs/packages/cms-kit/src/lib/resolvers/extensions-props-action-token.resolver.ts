...
import { MenuItem_Toolbar_Action } from "./page-default-toolbar-actions";
import { eCmsKitRouteName } from "../enums";
// import { Comments_Entity_Props } from "./table-default-entity-props";
// import { Comments_Entity_Action } from "./table-default-entity-actions";
...
export const Default_Entity_Actions = {
  ...
  // [eCmsKitRouteName.Comments]:Comments_Entity_Action,
};
