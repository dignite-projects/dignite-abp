...
public class EfCoreTenantDomainRepository : EfCoreRepository<IMultiTenancyDomainsDbContext, TenantDomain, Guid>, ITenantDomainRepository
{
    public EfCoreTenantDomainRepository(
        IDbContextProvider<IMultiTenancyDomainsDbContext> dbContextProvider
        )
