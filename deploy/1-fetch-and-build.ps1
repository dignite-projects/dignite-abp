...
################################################################
Write-Info "Pulling Dignite Abp $branch branch from GitHub"
cd ..
git switch $branch
git pull origin

################################################################
Write-Info "Building Dignite Abp repository"
cd build
.\build-all-release.ps1

Write-Info "Completed: Building Dignite Abp repository"
