...
echo "@dignite-ng:registry=http://verdaccio:4873" >> .npmrc
echo '@volo:registry=http://verdaccio:4873' >> .npmrc

npx npm-check-updates --filter '/^@(dignite-ng|volo)\/.*$/' --registry http://verdaccio:4873 --target greatest --packageFile package.json -u
