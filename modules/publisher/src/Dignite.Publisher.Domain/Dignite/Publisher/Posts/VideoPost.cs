...
public class VideoPost : Post
{
    ...
    public VideoPost(Guid id, string? locale, string title, string slug, string? coverBlobName, string? summary, 
    ...
    public virtual void Update(string? locale, string title, string slug, string? coverBlobName, string? summary, DateTime? publishedTime, IEnumerable<Guid> categoryIds, string videoUrl, TimeSpan duration, string? description)
    {
