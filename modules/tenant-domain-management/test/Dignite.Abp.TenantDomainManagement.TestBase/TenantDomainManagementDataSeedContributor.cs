...
public class TenantDomainManagementDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    private readonly ICurrentTenant _currentTenant;
    private readonly TenantDomainManagementTestData _testData;
    ...
    public TenantDomainManagementDataSeedContributor(
        ICurrentTenant currentTenant,  
        TenantDomainManagementTestData testData,
