...
namespace FileExplorerSample.Migrations
{
    /// <inheritdoc />
    public partial class UpgradeToAbp7 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropIndex(
                name: "IX_FepFileDescriptors_TenantId_ContainerName_CreatorId_DirectoryId",
                table: "FepFileDescriptors");

            migrationBuilder.DropIndex(
                name: "IX_FepFileDescriptors_TenantId_CreatorId",
                table: "FepFileDescriptors");

            migrationBuilder.DropIndex(
                name: "IX_FepFileDescriptors_TenantId_EntityId",
                table: "FepFileDescriptors");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FepFileDescriptors_TenantId_ContainerName_CreatorId_DirectoryId",
                table: "FepFileDescriptors",
                columns: new[] { "TenantId", "ContainerName", "CreatorId", "DirectoryId" });
